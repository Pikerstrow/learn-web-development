<template>
  <div
    :style="{backgroundColor: styles.backgroundColor, position: styles.position, boxShadow: styles.boxShadow}"
    class="d-flex align-items-center justify-content-center navbar-container"
  >
    <div class="app-container">
      <div
        :style="{borderBottom: styles.borderBottom}"
        class="d-flex justify-content-between main-menu"
      >
        ...
        <div class="d-flex justify-content-end align-items-center menu-div-container">
            ...
            <div class="d-flex justify-content-end align-items-center hamburger-menu-container">
                <div
                    @click="toggleMenu"
        ...
        <div class="hidden-menu-items-container">
          <ul :class="{'active': isOpened}" class="hidden-menu-ul">
            <li @click="toggleMenu" class="hidden-menu-li">
              <router-link tag="a" :to="{name: 'main', params: {locale: locale}}">Main</router-link>
            </li>
            <li @click="toggleMenu" class="hidden-menu-li">
              <router-link tag="a" :to="{name: 'tutorials', query: {page: 1}}">Tutorials</router-link>
            </li>
            <li @click="toggleMenu" class="hidden-menu-li">
              <router-link tag="a" to>Guest Book</router-link>
            </li>
            <li @click="toggleMenu" class="hidden-menu-li">
              <router-link tag="a" to>Blog</router-link>
            </li>
          </ul>
        </div>
  ...
  ul.active {
    ...
    li {
      ...
      @for $i from 0 through $menu--items--count {
        &:nth-child(#{$i}) {
          transition-delay: 0.4 * $i / 8 + 0.5 + s;
        }
      }
    }
  }
